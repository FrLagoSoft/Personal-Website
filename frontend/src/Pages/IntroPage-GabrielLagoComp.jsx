...
const BIGHEXES  = "133,0 266,76.5 266,229.5 133,306 0,229.5 0,76.5"
const SMALLHEXS = "66,0 133,38.25 133,114.75 66,153 0,114.75 0,38.25"
        ...
        <div className="fixed inset-0 flex">
            ...
            <div className="relative flex items-center justify-center w-1/2"
                ...
                <svg viewBox="0 0 266 306"
                    ...
                    <polygon points={BIGHEXES} fill="#5BD765" />
                </svg>
                ...
                >
                    <polygon points={BIGHEXES} fill="#9DE7A3" />
                </motion.svg>
                ...
                {childHexes.map((c, i) => (
                    ...
                    >
                        <polygon points={SMALLHEXS} fill="#DFF6E0" stroke="#9DE7A3" strokeWidth="3" />
                    </motion.svg>
                ))}
            </div>
